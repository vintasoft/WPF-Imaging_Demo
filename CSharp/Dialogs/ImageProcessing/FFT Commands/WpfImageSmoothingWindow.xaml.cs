...
{
    /// <summary>
    /// A window that allows to view and edit settings for ImageSmoothingCommand.
    /// </summary>
    public partial class WpfImageSmoothingWindow : Window
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WpfImageSmoothingWindow"/> class.
        /// </summary>
        public WpfImageSmoothingWindow(WpfImageViewer viewer)
        {
            InitializeComponent();
            _imageProcessingPreviewInViewer = new WpfImageProcessingPreviewInViewer(viewer);
            this.Title = "Image Smoothing";
            ...
            grayscaleFiltrationCheckBox.IsChecked = false;
        }
        ...
        public ProcessingCommandBase GetProcessingCommand()
        {
            ...
            command.Radius = (float)radiusEditorControl.Value;
