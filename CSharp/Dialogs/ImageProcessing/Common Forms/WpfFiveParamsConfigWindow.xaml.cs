...
{
    /// <summary>
    /// A window for image processing function with five parameters.
    /// </summary>
    public partial class WpfFiveParamsConfigWindow : Window
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WpfFiveParamsConfigWindow"/> class.
        /// </summary>
        public WpfFiveParamsConfigWindow(WpfImageViewer viewer, string dialogName, WpfImageProcessingParameter parameter1, WpfImageProcessingParameter parameter2, WpfImageProcessingParameter parameter3, WpfImageProcessingParameter parameter4, WpfImageProcessingParameter parameter5)
        {
            InitializeComponent();
            ...
            valueEditorControl4.ValueHeader = parameter4.Name;
            ...
            valueEditorControl5.ValueHeader = parameter5.Name;
        ...
        protected void ExecuteProcessing()
        {
            ...
            _parameter4 = (int)Math.Round(valueEditorControl4.Value);
            _parameter5 = (int)Math.Round(valueEditorControl5.Value);
