...
{
    /// <summary>
    /// A window for image processing function with six parameters.
    /// </summary>
    public partial class WpfSixParamsConfigWindow : Window
    {
        ...
        /// </summary>
        public WpfSixParamsConfigWindow(
            ...
            WpfImageProcessingParameter parameter4,
            WpfImageProcessingParameter parameter5,
            WpfImageProcessingParameter parameter6)
        {
            InitializeComponent();
            ...
            valueEditorControl6.ValueHeader = parameter6.Name;
        ...
        protected void ExecuteProcessing()
        {
            ...
            _parameter6 = (int)Math.Round(valueEditorControl6.Value);
